			...
			<table id="table_report"
				...
				<tr>
					...
					<td><input type="text" class="form-control input-sm" id="name"
						name="name" value="${pd.areaInfo.name}" placeholder="这里输入区域名称"
						title="区域名称"></td>
				...
				<%-- <tr>
					<td style="width: 100px; text-align: right;">区域缩放比例</td>
	            	<td style="text-align:left;">
	            		<input type="text" class="form-control input-sm" id="areaExaggeratedScale" name="areaExaggeratedScale" value="${pd.areaExaggeratedScale}" placeholder="这里输入区域缩放比例" title="区域缩放比例">
	            	</td>
	            	<td style="width:100px;text-align:right;"></td>
					<td>
