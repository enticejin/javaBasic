    ...
    var html = '\
    	  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 12) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;    -moz-box-shadow:0px 0px 20px #333333; -webkit-box-shadow:0px 0px 20px #333333; box-shadow:0px 0px 20px #333333;">\
    	    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
    	      <td width="6" height="40" style="background:#438eb9"><div style="width: 6px;"></div></td>\
    	      <td height="40" style="background:#438eb9">\
    	      	<div style="padding:2px 0 0 4px; float: left; font-weight: bold; color:#fff;"><i class=" fa fa-clone" style="color:#FFFFFF;margin-right:5px;font-size:16px;"></i><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
    	        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" style="margin-top:2px;margin-right:5px; line-height:18px;text-align:center; position: relative; cursor: pointer; float: right; height: 18px; width: 18px; "><i class=" fa fa-close" style="color:#FFFFFF;"></i></div>\
    	      </td>\
    	      <td width="6" height="40" style="background:#438eb9"><div style="width: 6px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    	    </tr>\
    	    <tr valign="top">\
    	      <td width="6" style="background:#438eb9"></td>\
    	    ...
    	    <tr>\
    	      <td width="6" height="6" style="background:#438eb9"></td>\
    	      <td style="background:#438eb9"></td>\
    	      <td width="6" height="6" style="background:#438eb9"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    	    </tr>\
    	  </table>\
    	</div>\
    	'
