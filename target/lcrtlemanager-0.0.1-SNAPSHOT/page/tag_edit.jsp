			...
			<table id="table_report"
				...
				<tr>
					...
					<td><input type="text" class="form-control input-sm" id="tagId"
						name="tagId" value="${pd.tagInfo.id}" readonly="readonly"
						title="标签ID">
				...
				<tr>
					...
					<td><input type="text" class="form-control input-sm"
						id="icon" name="defaultIcon" value="${pd.tagInfo.defaultIcon}"
						placeholder="这里输入缺省图标信息" title="缺省图标" readonly="readonly"></td>
				</tr>
			</table>		
		</div>
