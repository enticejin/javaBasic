 ...
 *
 */
public class OverlaidDrawBarLine extends ApplicationFrame {
     ...
     */
    public OverlaidDrawBarLine(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final OverlaidDrawBarLine demo = new OverlaidDrawBarLine("Overlaid XYPlot Demo");
        demo.pack();
