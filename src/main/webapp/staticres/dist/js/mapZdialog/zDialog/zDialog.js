...
Dialog.prototype.create = function () {
  ...
  //添加开始，如果是百分比，则换成像素值 2016-10-19
    ...
    var html = '\
    	  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 12) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;    -moz-box-shadow:0px 0px 20px #333333; -webkit-box-shadow:0px 0px 20px #333333; box-shadow:0px 0px 20px #333333;">\
    	    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
    	      <td width="6" height="40" style="background:#438eb9;opacity:0.5;"><div style="width: 6px;"></div></td>\
    	      <td height="40" style="background:#438eb9;opacity:0.5;">\
    	      	<div style="margin-top:8px;padding:2px 0 0 4px; float: left; font-weight: bold; color:#fff;"><i class=" fa fa-clone" style="color:#FFFFFF;margin-right:5px;font-size:16px;"></i><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
    	        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" style="margin-top:8px;margin-right:5px; line-height:18px;text-align:center; position: relative; cursor: pointer; float: right; height: 18px; width: 18px; "><i class=" fa fa-close" style="color:#FFFFFF;"></i></div>\
    	      </td>\
    	      <td width="6" height="40" style="background:#438eb9;opacity:0.5;"><div style="width: 6px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    	    </tr>\
    	    <tr valign="top">\
    	      <td width="6" style="background:#438eb9;opacity:0.5;"></td>\
    		...
    		' + (function (obj) {
    	        ...
    	        return "";
    	          ...
    	          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
    	            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#FFFFFF;">\
    	                <button id="_ButtonOK_' + this.ID + '" type="button" class="btn btn-success btn-flat">确 定</button>\
    	                <button onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '" type="button" class="btn btn-default btn-flat">取 消</button>\
    	              </div></td>\
    	          </tr>\
    	        </table></td>\
    	      <td width="6" style="background:#438eb9;opacity:0.5;"></td>\
    	    ...
    	    <tr>\
    	      <td width="6" height="6" style="background:#438eb9;opacity:0.5;"></td>\
    	      <td style="background:#438eb9;opacity:0.5;"></td>\
    	      <td width="6" height="6" style="background:#438eb9;opacity:0.5;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    	    </tr>\
    	  </table>\
    	</div>\
    	'
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" width="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="center" style="background:#FFFFFF;width:40px;"><i class="fa fa-info" style="font-size:25px;color:green;"></i></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:11pt;background:#FFFFFF;">' + msg + '</td></tr>\
	</table>';
    diag.show();
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" width="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="center" style="background:#FFFFFF;width:40px;"><i class="fa  fa-question" style="font-size:25px;color:orange;"></i></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:11pt;background:#FFFFFF;">' + msg + '</td></tr>\
	</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
