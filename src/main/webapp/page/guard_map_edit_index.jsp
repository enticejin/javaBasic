	...
	<script type="text/javascript">		
		...
		var vectorAreas = new ol.layer.Vector({
	    	...
	    	source: new ol.source.Vector({
	    			url: '${basePath}/guardArea/json_guard_byId.do?guardId=${guardId}',
		...
		function loadPlanMap(map)
		{
			...
			$.ajax({
				type: "get",
 				url: '${basePath}/map/getGuardPlanMapData.do?guardId='+guardId,
				dataType:'json',
				async:false,
...
// 		}
		...
		function saveGeoJson(json) {
			...
			$.ajax({
				type: "post",
				url: '${basePath}/guardArea/saveGuardMapData.do?guardId=${guardId}',
		    	data: {json:json},
				dataType:'json',
				success: function(data){
					hideLoading();
