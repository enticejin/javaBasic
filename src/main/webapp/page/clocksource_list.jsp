		...
		<form action="cslist.do" method="post" name="Form" id="Form">
			...
			<table style="width:100%;">
				<tr>
					...
					<td style="vertical-align:top;">
						<a class="btn btn-small btn-success btn-sm btn-flat" name="needToShowTagList" onclick="needToShowTagList();">添加至需要显示测距消息的时钟源列表</a>
					</td>
	...
	<script type="text/javascript">
		...
		function del(Id){
			Dialog.confirm("确定要删除吗?", function(){
				...
				$.ajax({
					type: "POST",
					url: "${basePath}/clocksource/delete.do?clockSourceId="+Id+"&tm="+new Date().getTime(),
					dataType:'json',
					cache: false,
					success: function(data){
						hideLoading(); 
						if(data.status=="ok")
							{
								...
								{
									console.log(data.zhong);
									Dialog.alert("该时钟已被   "+data.zhong+"占用，请解除该时钟后删除！");	
								}	
					},
