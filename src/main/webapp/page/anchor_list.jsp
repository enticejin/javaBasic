		...
		<form action="list.do" method="post" name="Form" id="Form">
			...
			<table style="width:100%;">
				<tr>
					...
					<td style="vertical-align:top;">
						<a class="btn btn-small btn-success btn-sm btn-flat" name="needToShowTagList" onclick="needToShowAnchorList();">添加至需要显示测距消息的基站列表</a>
					</td>
			...
			var idsList = [];
			  $('input:checkbox').each(function(){
		        ...
		        if(idsList.length == 0){
					...
					showDialog.Title = "需要显示测距消息的基站列表";
					showDialog.URL = '${basePath}/need_show_anchor_range/needToShowAnchorList.do?idsList='+idsList;
