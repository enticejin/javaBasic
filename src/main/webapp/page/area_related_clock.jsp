...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script type="text/javascript">
		...
		//异步传输数据
		function submitClockForm(){
			var areaId ="${pd.areaId}";
			var clockIdByArea ="${pd.clockIdByArea}";
			var mydata = $("#Form").serialize();  
			$.ajax({
				type:'POST',  
			    url:'${basePath}/need_show_area_range/save.do?areaId='+areaId+'&flag=clock'+'&clockIdByArea='+clockIdByArea, 
			    cache: false,
