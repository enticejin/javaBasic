...
public class RedisConfig extends CachingConfigurerSupport {
	 ...
	 */
	@Bean
	public ListOperations<String, Object> listOprations(RedisTemplate<String, Object> template){
	 ...
	 */
	@Bean
	public SetOperations<String, Object> setOptions(RedisTemplate<String, Object> template){
