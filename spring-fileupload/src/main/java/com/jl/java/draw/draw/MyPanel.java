...
class Ball extends Thread {
    ...
    int index = 0;
    Map<String, Object> mapSeq = seqUtil.getSeqPosition(index, filePath);
    // 最后的seq序号
    ...
    //seq序号区间内的所有信息
    List<String> seqOriginListArea = seqUtil.getColSeq(filePath, seqNow, finalSeqNo);
    ...
    //double[] xList = seqUtil.getFunctionX(xList);
    //double[] yList = map.get("yList");
